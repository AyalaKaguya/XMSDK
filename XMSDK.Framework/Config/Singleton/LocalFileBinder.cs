...
{
    // 存储已绑定的类型和文件路径的映射
    private static readonly Dictionary<Type, string> BoundTypes = new();
    ...
    public static void BindAll()
    {
        ...
        var types = assemblies
            ...
            .Where(t => t.IsClass && t is { IsAbstract: true, IsSealed: true } && t.GetCustomAttribute<BindLocalFileAttribute>() != null);
    ...
    private static void LoadPropertiesFromJson(Type type, JsonElement jsonElement)
    {
        ...
        {
            if (nestedType is { IsClass: true, IsAbstract: true, IsSealed: true })
            {
